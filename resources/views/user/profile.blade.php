    ...
    <div class="container mx-auto px-6">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mb-12">
                <div class="w-32 h-32 bg-gradient-to-br from-teal-600 to-blue-400 rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl">
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden mb-8">
                <div class="bg-gradient-to-r from-teal-600 to-blue-400 p-6">
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div id="display-mode">
                        <div class="group">
                            ...
                            <div class="bg-gradient-to-r from-blue-50 to-teal-50 border border-emerald-200 rounded-xl px-4 py-4 text-gray-900 font-medium">
                                {{ $user->name }}
                            </div>
                        </div>
                        ...
                        <div class="group mt-6">
                            ...
                            <div class="bg-gradient-to-r from-blue-50 to-teal-50 border border-emerald-200 rounded-xl px-4 py-4">
                                <span class="inline-block bg-gradient-to-r from-blue-400 to-teal-500 text-white px-4 py-2 rounded-full text-sm font-semibold capitalize">
                                    {{ $user->role }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="pt-6 border-t border-gray-200">
                            <button onclick="toggleEditMode()" class="w-full bg-gradient-to-r from-blue-400 to-teal-500 text-white px-6 py-3 rounded-xl hover:from-teal-500 hover:to-teal-600 transition-all duration-300 font-semibold">
                                Edit Profile
                            </button>
                        </div>
                    </div>
                        ...
                        <form action="{{ route('user.profile.update') }}" method="POST">
                            ...
                            <div class="group">
                                ...
                                <input 
                                    ...
                                    class="w-full bg-gradient-to-r from-blue-50 to-teal-50 border border-emerald-200 rounded-xl px-4 py-4 text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300"
                                    required
                                >
                                @error('name')
                            ...
                            <div class="pt-6 border-t border-gray-200">
                                <div class="flex flex-col sm:flex-row gap-4">
                                    <button type="submit" class="flex-1 bg-gradient-to-r from-blue-400 to-teal-500 text-white px-6 py-3 rounded-xl hover:from-teal-500 hover:to-teal-600 transition-all duration-300 font-semibold">
                                        Save Changes
                                    </button>
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div class="p-8">
                    <form action="{{ route('auth.logout') }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="w-full bg-gradient-to-r from-blue-400 to-teal-500 text-white px-6 py-3 rounded-xl hover:from-red-400 hover:to-red-400 transition-all duration-300 font-semibold">
                            Logout
                        </button>
                    </form>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div class="bg-white rounded-2xl shadow-lg p-6 text-center">
                    <div class="w-16 h-16 bg-gradient-to-br from-emerald-500 to-blue-400 rounded-full flex items-center justify-center mx-auto mb-4">
                        <span class="text-2xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#292929" viewBox="0 0 256 256">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">{{ $totalPlant }}</h3>
                    <p class="text-gray-600">Plants Purchased</p>
                </div>

                <div class="bg-white rounded-2xl shadow-lg p-6 text-center">
                    <div class="w-16 h-16 bg-gradient-to-br from-blue-400 to-teal-500 rounded-full flex items-center justify-center mx-auto mb-4">
                        <span class="text-2xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#292929" viewBox="0 0 256 256">
                                <path d="M223.68,66.15L135.68,18a15.88,15.88,0,0,0-15.36,0l-88,48.17a16,16,0,0,0-8.32,14v95.64a16,16,0,0,0,8.32,14l88,48.17a15.88,15.88,0,0,0,15.36,0l88-48.17a16,16,0,0,0,8.32-14V80.18A16,16,0,0,0,223.68,66.15ZM128,32l80.34,44-29.77,16.3-80.35-44ZM128,120L47.66,76l33.9-18.56,80.34,44ZM40,90l80,43.78v85.79L40,175.82Zm176,85.78h0l-80,43.79V133.82l32-17.51V152a8,8,0,0,0,16,0V107.55L216,90v85.77Z"/>
                            </svg>
                        </span>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">{{ $totalOrders }}</h3>
                    <p class="text-gray-600">Orders Completed</p>
                </div>

                <div class="bg-white rounded-2xl shadow-lg p-6 text-center">
                    <div class="w-16 h-16 bg-gradient-to-br from-teal-500 to-blue-400 rounded-full flex items-center justify-center mx-auto mb-4">
                        <span class="text-2xl"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#292929" viewBox="0 0 256 256">
